...
export default function ParticipantDifficulteScreen() {
  ...
  const fetchParticipant = async () => {
    try {
      const docRef = doc(db, "participants", "TLJmTTT4xRsKbdnjA1SM");
  ...
  useEffect(() => {
    ...
    gsap.fromTo(".parcours", { y: 300, opacity: 0 }, { y: 50, opacity: 1, duration: 0.8, stagger: 0.2 });
  ...
  return (
    <div className='participantDifficulte'>
      ...
      <div className='nameCandidat'>
        <h1>Oriane Bertone</h1>
      </div>
      <div className='page-content'>
        <div className='candidatImg'>
          <img src="images/partDifficulte.png" alt="partVitesse" />
        </div>
      </div>
